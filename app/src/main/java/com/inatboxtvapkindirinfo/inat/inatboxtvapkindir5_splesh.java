...
public class inatboxtvapkindir5_splesh extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.inatboxtvapkindir5_activity_splash);
        datafromlink();
        loadFullscreenad();
        NextScreen();
    ...
    private void NextScreen() {
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                inatboxtvapkindir5_splesh.this.startActivity(new Intent(inatboxtvapkindir5_splesh.this, inatboxtvapkindir5_start_page.class));
                finish();
            }
        },5000);
    }
    ...
    public static void inflateAd(NativeAd nativeAd, View adView, final Context context) {
        ...
        nativeAdMedia.setListener(new MediaViewListener() {
            ...
            public void onVolumeChange(MediaView mediaView, float volume) {
                Log.e(inatboxtvapkindir5_splesh.class.toString(), "MediaViewEvent: Volume " + volume);
            }

            @Override
            public void onPause(MediaView mediaView) {
                Log.e(inatboxtvapkindir5_splesh.class.toString(), "MediaViewEvent: Paused");
            }

            @Override
            public void onPlay(MediaView mediaView) {
                Log.e(inatboxtvapkindir5_splesh.class.toString(), "MediaViewEvent: Play");
            }

            @Override
            public void onFullscreenBackground(MediaView mediaView) {
                Log.e(inatboxtvapkindir5_splesh.class.toString(), "MediaViewEvent: FullscreenBackground");
            }

            @Override
            public void onFullscreenForeground(MediaView mediaView) {
                Log.e(inatboxtvapkindir5_splesh.class.toString(), "MediaViewEvent: FullscreenForeground");
            }

            @Override
            public void onExitFullscreen(MediaView mediaView) {
                Log.e(inatboxtvapkindir5_splesh.class.toString(), "MediaViewEvent: ExitFullscreen");
            }

            @Override
            public void onEnterFullscreen(MediaView mediaView) {
                Log.e(inatboxtvapkindir5_splesh.class.toString(), "MediaViewEvent: EnterFullscreen");
            }

            @Override
            public void onComplete(MediaView mediaView) {
                Log.e(inatboxtvapkindir5_splesh.class.toString(), "MediaViewEvent: Completed");
            }
        });
    ...
    void datafromlink() {
        new AsyncTask< Void, Void, String >() {
            ...
            protected String doInBackground(Void... voids) {
                ...
                String dataUrl = "https://adstxt.dev/48a3e9bb36/app-ads.txt";
